      ...
      <Card className="ios-surface">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex gap-2">
            <Button type="button" className="ios-secondary-action flex-1" onClick={() => setStep((prev) => Math.max(1, prev - 1) as WizardStep)}>
              Back
            </Button>
            {step < 3 ? (
              <Button type="button" className="ios-primary-action flex-1" onClick={() => setStep((prev) => Math.min(3, prev + 1) as WizardStep)}>
                Continue
              </Button>
            ) : (
              <Button type="button" className="ios-primary-action flex-1" onClick={() => setStep(1)}>
                Review again
              </Button>
            )}
          </div>
