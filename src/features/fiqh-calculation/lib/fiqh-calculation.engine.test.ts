...
describe("fiqh calculation engine", () => {
  ...
  it.each([
    ...
    expect(result.hawl).toMatchObject({
      ...
      asOf,
      elapsedDays: 317,
      requiredDays: getHijriYearLengthDays(new Date("2025-07-01T00:00:00Z")),
      isComplete: false,
  ...
  it("calculates the frozen snapshot and due amount for an above-nisab, complete hawl case", () => {
    ...
    expect(result).toMatchObject({
      ...
      hawl: {
        ...
        asOf,
        elapsedDays: 378,
        requiredDays: getHijriYearLengthDays(new Date("2025-05-01T00:00:00Z")),
        isComplete: true,
        resetRequired: false,
      },
      explanation: {
  ...
  it("treats an exact nisab match as above nisab and due only once the hawl is complete", () => {
    ...
    expect(result).toMatchObject({
      ...
      hawl: {
        ...
        asOf,
        elapsedDays: 347,
        requiredDays: getHijriYearLengthDays(new Date("2025-06-01T00:00:00Z")),
        isComplete: false,
        resetRequired: false,
      },
      explanation: {
